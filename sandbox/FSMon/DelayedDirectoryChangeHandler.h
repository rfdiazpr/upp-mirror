...
//
{
	...
	public:
		...
		virtual ~CDelayedNotificationWindow()
		{
			Release();
		}
...
//
{
	...
	private:
		...
		BOOL WaitForThreadStartup()
		{
			return WaitForSingleObject(m_hThreadStartEvent, INFINITE) == WAIT_OBJECT_0;
		};

		BOOL SignalThreadStartup()
		{
			return SetEvent(m_hThreadStartEvent) ;
		}
...
//
{
	...
	public:
		...
		CDirectoryChangeHandler * & GetRealChangeHandler()
		{
			return m_pRealHandler;    //FYI: PCLint will give a warning that this exposes a private/protected member& defeats encapsulation.
		}
