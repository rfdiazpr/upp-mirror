	...
	do
	{
		...
		switch (notify_info.GetAction())
		{
			...
			case FILE_ACTION_ADDED:		// a file was added!
				...
				pChangeHandler->On_FileAdded(notify_info.GetFileNameWithPath(pdi->m_strDirName));
				break;

			case FILE_ACTION_REMOVED:	//a file was removed

				pChangeHandler->On_FileRemoved(notify_info.GetFileNameWithPath(pdi->m_strDirName));
				break;

			case FILE_ACTION_MODIFIED:
				//a file was changed
				//pdi->m_pChangeHandler->On_FileModified( strLastFileName ); break;
				pChangeHandler->On_FileModified(notify_info.GetFileNameWithPath(pdi->m_strDirName));
				break;
