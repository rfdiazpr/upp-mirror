...
private:
	...
	void OnBackupMenu(Ctrl *owner);
		void OnBackupNone(Data *owner);
		void OnBackupSeparate(Data *owner);
		void OnBackupChapter(Data *owner);

	static void DoBrowseDir(Data& owner, const char *name);
...
void DlgFilesSetup::DoBrowseDir(Data& owner, const char *name)
{
	FileSel fsel;
...
void DlgFilesSetup::OnBackupNone(Data *owner)
{
	*owner <<= Null;
}

void DlgFilesSetup::OnBackupSeparate(Data *owner)
{
	String path;
...
void DlgFilesSetup::OnBackupChapter(Data *owner)
{
	String path;
