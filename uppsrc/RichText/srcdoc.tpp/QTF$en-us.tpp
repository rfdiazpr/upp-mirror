...
REF("label")
TOPIC_TEXT(
"[2 $$0,0#00000000000000000000000000000000:Default][@(128.0.255)2 $$1,0#65874547464505293575048467215454:QTF "
"Chr][*/+117 $$2,0#07143242482611002448121871408047:title][*C@3+75 $$3,3#36268203433472503231438721581057:code][{_}%EN-US "
"[s0;=*8 QTF&][s0; &][s0; QTF is the native format of Ultimate`+`+ rich texts (formatted "
"texts).&][s0; &][s0; It is byte oriented format. Bytes with values 2`-31 are ignore")
TOPIC_TEXT(
"d. Other are interpreted as characters or formatting commands.&][s0; &][s0; Letters "
"([@4 a]`-[@4 zA]`-[@4 Z]), numbers ([@4 0]`-[@4 9]), space (32) and characters&][s0; "
"&][s0;*@4 . , ; ! ? % ( ) / < > #&][s0; &][s0; and bytes greater than 127 are guaranteed "
"to be never used as command characters (not even in future versions of QTF). Other "
"characters should be prefixed with escape character `` (rev")
TOPIC_TEXT(
"erse apostrophe). Group of characters can be escaped using byte 1. Example:&][s0; "
"&][s3; `\"`\\1a`[x`]`\\1`[`* bold`]`\"&][s0; &][s0; Byte 0 represents the end of "
"input sequence.&][s0; &][s0; Dimension units of QTF are dots `- one dot is defined "
"as 1/600 of inch.&][s0; &][s0; Colors are described as either number [@(128.0.255) "
"0]`-[@(128.0.255) 9], with meaning&][s0; &][ {{1000:1000:1000:1000:1000:100")
TOPIC_TEXT(
"0:1000:1000:1000:1000<96;>96;f4; [s0;=* [%00-00 0]]:: [s0;=* [%00-00 1]]:: [s0;=* "
"[%00-00 2]]:: [s0;=* [%00-00 3]]:: [s0;=* [%00-00 4]]:: [s0;=* [%00-00 5]]:: [s0;=* "
"[%00-00 6]]:: [s0;=* [%00-00 7]]:: [s0;=* [%00-00 8]]:: [s0;=* [%00-00 9]]::l/0r/0t/0b/0@0 "
"[s0;0 ]::@1 [s0;0 ]::@2 [s0;0 ]::@3 [s0;0 ]::@4 [s0;0 ]::@5 [s0;0 ]::@6 [s0;0 ]::@7 "
"[s0;0 ]::@8 [s0;0 ]::@9 [s0;0 ]::l/25r/25t/15b/15@2 [s0;=1 ")
TOPIC_TEXT(
"[%00-00 Black]]:: [s0;=1 LtGray]:: [s0;=1 White]:: [s0;=1 [%00-00 Red]]:: [s0;=1 "
"[%00-00 Green]]:: [s0;=1 [%00-00 Blue]]:: [s0;=1 [%00-00 LtRed]]:: [s0;=1 [%00-00 "
"WhiteGray]]:: [s0;=1 [%00-00 LtCyan]]:: [s0;=1 [%00-00 Yellow]]}}&][s0; &][s0; or "
"letters&][s0; &][ {{1109:1109:1109:1109:1109:1109:1109:1109:1128<96;>96;f4; [s0;=*C@(128.0.255) "
"[%00-00 b]]:: [s0;=*C@(128.0.255) [%00-00 c]]:: [s0;=*C@(12")
TOPIC_TEXT(
"8.0.255) [%00-00 g]]:: [s0;=*C@(128.0.255) [%00-00 k]]:: [s0;=*C@(128.0.255) [%00-00 "
"l]]:: [s0;=*C@(128.0.255) [%00-00 m]]:: [s0;=*C@(128.0.255) [%00-00 o]]:: [s0;=*C@(128.0.255) "
"[%00-00 r]]:: [s0;=*C@(128.0.255) [%00-00 y]]::l/0r/0t/0b/0@5 [s0;0 ]::@(0.128.128) "
"[s0;0 ]::@4 [s0;0 ]::@0 [s0;0 ]::@1 [s0;0 ]::@(128.0.255) [s0;0 ]::@(128.128.0) [s0;0 "
"]::@3 [s0;0 ]::@9 [s0;0 ]::l/25r/25t/15b/15@2 [s0;=")
TOPIC_TEXT(
"1 [%00-00 Blue]]:: [s0;=1 [%00-00 Cyan]]:: [s0;=1 [%00-00 Green]]:: [s0;=1 [%00-00 "
"Black]]:: [s0;=1 [%00-00 LtGray]]:: [s0;=1 [%00-00 Magenta]]:: [s0;=1 [%00-00 Brown]]:: "
"[s0;=1 [%00-00 Red]]:: [s0;=1 [%00-00 Yellow]]}}&][s0; &][ {{1109:1109:1109:1109:1109:1109:1109:1109:1128<96;>96;f4; "
"[s0;=*@(128.0.255) [%00-00 B]]:: [s0;=*@(128.0.255) [%00-00 C]]:: [s0;=*@(128.0.255) "
"[%00-00 G]]:: [s0;=*@(128.0")
TOPIC_TEXT(
".255) [%00-00 K]]:: [s0;=*@(128.0.255) [%00-00 L]]:: [s0;=*@(128.0.255) [%00-00 "
"M]]:: [s0;=*@(128.0.255) [%00-00 W]]:: [s0;=*@(128.0.255) [%00-00 R]]:: [s0;=*@(128.0.255) "
"[%00-00 Y]]::l/0r/0t/0b/0@(0.0.255) [s0;0 ]::@8 [s0;0 ]::@(0.255.0) [s0;0 ]::@(128) "
"[s0;0 ]::@(238) [s0;0 ]::@(255.0.255) [s0;0 ]::@2 [s0;0 ]::@6 [s0;0 ]::@(255.255.180) "
"[s0;0 ]::l/25r/25t/15b/15@2 [s0;=1 [%00-00 LtBlue]]:: [s0;=")
TOPIC_TEXT(
"1 [%00-00 LtCyan]]:: [s0;=1 [%00-00 LtGreen]]:: [s0;=1 [%00-00 Gray]]:: [s0;=1 [%00-00 "
"WhiteGray]]:: [s0;=1 [%00-00 LtMagenta]]:: [s0;=1 [%00-00 White]]:: [s0;=1 [%00-00 "
"LtRed]]:: [s0;=1 [%00-00 LtYellow]]}}&][s0; &][s0; or as the RGB value in form&][s0; "
"&][s0;@(128.0.255) ([/@(0.0.255) number].[/@(0.0.255) number].[/@(0.0.255) number])&][s0;@(128.0.255) "
"&][s0; where [/@(0.0.255) number] is 0`-255")
TOPIC_TEXT(
".&][s0; &][s0;/@(0.0.255) [/@0 Form with single ]number&][s0; &][s0;@(128.0.255) "
"([/@(0.0.255) number])&][s0;@(128.0.255) &][s0; specifies grays.&][s0; &][s0; Letter&][s0; "
"&][s0;@(128.0.255) N&][s0;@(128.0.255) &][s0; used in place of color designates transparent "
"color.&][s0; &][s0; &][s2; Basic QTF codes&][s0; &][s0; &][ {{2003:7997<96;>96; [s1;C "
"`_]:: [s0; Hard`-space `- space that cannot be div")
TOPIC_TEXT(
"ided at the end of line.]:: [s1;C `&]:: [s0; New paragraph.]:: [s1;C `-`|]:: [s0; "
"Tabulator]}}&][s0; &][s0; &][s2; Character and paragraph formatting&][s0; &][s0; "
"Character and paragraph formatting starts with&][s0;@(128.0.255) &][s0;@(128.0.255) "
"`[&][s0;@(128.0.255) &][s0; character followed by [*/ character/paragraph formating][/ "
" sequence] ended with single space character and applies to the te")
TOPIC_TEXT(
"xt until matching&][s0; &][s0;@(128.0.255) `]&][s0;@(128.0.255) &][s0; is encountered.&][s0; "
"&][ {{1879:8121^@(229.229.248)-1 [s1;*/@0 Character/paragraph formating sequence]::=@2 "
"[s0; ]::^ [s1;C [%00-00 /]]::= [s0; Italic.]::^ [s1;C [%00-00 `*]]::= [s0; Bold.]::^ "
"[s1;C [%00-00 `_]]::= [s0; Underline.]::^ [s1;C [%00-00 `-]]::= [s0; Strikeout.]::^ "
"[s1;C [%00-00 c]]::= [s0; Capitals.]::^ [s1;C [%00-")
TOPIC_TEXT(
"00 ``]]::= [s0; Superscript.]::^ [s1;C [%00-00 ,]]::= [s0; Subscript.]::^ [s1;C "
"[%00-00 d]]::= [s0; Dashed underline.]::^ [s1;C [%00-00 `^][%00-00/@(0.0.255) text][%00-00 "
"`^]]::= [s0; Hyperlink.]::^ [s1;C [%00-00 I][%00-00/@(0.0.255) text][%00-00 ;]]::= "
"[s0; Index entry.]::^ [s1;/C@(0.0.255) [%00-00/@(128.0.255) `+][%00-00 number]]::= "
"[s0; Font height in dots.]::^ [s1;C [%00-00 0]]::= [s0; Font he")
TOPIC_TEXT(
"ight 50 dots (6 points).]::^ [s1;C [%00-00 1]]::= [s0; Font height 67 dots (8 points).]::^ "
"[s1;C [%00-00 2]]::= [s0; Font height 84 dots (10 points).]::^ [s1;C [%00-00 3]]::= "
"[s0; Font height 100 dots (12 points).]::^ [s1;C [%00-00 4]]::= [s0; Font height "
"134 dots (16 points).]::^ [s1;C [%00-00 5]]::= [s0; Font height 167 dots (20 points).]::^ "
"[s1;C [%00-00 6]]::= [s0; Font height 200 dots (24 poi")
TOPIC_TEXT(
"nts).]::^ [s1;C [%00-00 7]]::= [s0; Font height 234 dots (28 points).]::^ [s1;C "
"[%00-00 8]]::= [s0; Font height 300 dots (36 points).]::^ [s1;C [%00-00 9]]::= [s0; "
"Font height 400 dots (48 points).]::^ [s1;/C@(0.0.255) [%00-00/@(128.0.255) `@][%00-00 "
"color]]::= [s0; Text color.]::^ [s1;/C@(0.0.255) [%00-00/@(128.0.255) `$][%00-00 "
"color]]::= [s0; Text background color.]::^ [s1;C [%00-00 A]]::= [s0;")
TOPIC_TEXT(
" Arial font.]::^ [s1;C [%00-00 R]]::= [s0; Times New Roman font.]::^ [s1;C [%00-00 "
"C]]::= [s0; Courier font.]::^ [s1;C [%00-00 G]]::= [s0; Standard GUI font.]::^ [s1;C "
"[%00-00 S]]::= [s0; Symbol font.]::^ [s1;/C@(0.0.255) [%00-00/@(128.0.255) .][%00-00 "
"number]]::= [s0; Font with specified font [/@(0.0.255) number].]::^ [s1;C [%00-00 "
"!][%00-00/@(0.0.255) text][%00-00 !]]::= [s0; Font with face name")
TOPIC_TEXT(
" equal to [/@(0.0.255) text]. If such font does not exist on system, Arial is used.]::^ "
"[s1;C [%00-00 `{][%00-00/@(0.0.255) charset][%00-00 `}]&][s1;C ]::= [s0; Character "
"set. It can be defined as either single character&][s0; &][ {{1840:8160<330;>1757;f4;h1; "
"[s1;=C `_]:: [s0; utf`-8]:: [s1;=C 0]:: [s0; windows`-1250]:: [s1;=C 1]:: [s0; windows`-1251]:: "
"[s1;=C 2]:: [s0; windows`-1252]:: [s1;=C 3]:")
TOPIC_TEXT(
": [s0; windows`-1253]:: [s1;=C 4]:: [s0; windows`-1254]:: [s1;=C 5]:: [s0; windows`-1255]:: "
"[s1;=C 6]:: [s0; windows`-1256]:: [s1;=C 7]:: [s0; windows`-1257]:: [s1;=C A]:: [s0; "
"iso`-8859`-1]:: [s1;=C B]:: [s0; iso`-8859`-2]:: [s1;=C C]:: [s0; iso`-8859`-3]:: "
"[s1;=C D]:: [s0; iso`-8859`-4]:: [s1;=C E]:: [s0; iso`-8859`-5]:: [s1;=C F]:: [s0; "
"iso`-8859`-6]:: [s1;=C G]:: [s0; iso`-8859`-7]:: [s1;=C H]")
TOPIC_TEXT(
":: [s0; iso`-8859`-8]:: [s1;=C I]:: [s0; iso`-8859`-9]:: [s1;=C J]:: [s0; iso`-8859`-10]}}&][s0; "
"&][s0; or as the string designating character set (example: [*C@3 `\"`[`{`_`}_...`]`\"][* "
", ][*C@3 `\"`[`{windows`-1250`}_...`]`\"]).]::^ [s1;/C@(0.0.255) [%00-00/@(128.0.255) "
