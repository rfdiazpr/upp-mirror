...
`_BASE`_CLASS][3 _>]&]
[s1;:CRTP`_GraphCtrl`_Base`:`:class: [@(0.0.255) class]_[* CRTP`_GraphCtrl`_Base]_:_[@(0.0.255) p
ublic]_[*@3 GRAPHDRAW`_BASE`_CLASS]<[*@4 TYPES], [*@4 DERIVED]>, [@(0.0.255) public]_[*@3 C
trl]&]
[s2;%% &]
[s3; &]
