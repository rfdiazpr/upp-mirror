...
K_CTRL_MINUS     = K_CTRL|XK_minus|K_DELTA,
K_CTRL_GRAVE     = K_CTRL|XK_grave|K_DELTA,
K_CTRL_SLASH     = K_CTRL|XK_slash|K_DELTA,
K_CTRL_BACKSLASH = K_CTRL|XK_backslash|K_DELTA,
K_CTRL_COMMA     = K_CTRL|XK_comma|K_DELTA,
