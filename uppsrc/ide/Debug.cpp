...
One<Debugger> GdbCreate(One<Host> pick_ host, const String& exefile, const String& cmdline, bool console);
One<Debugger> Gdb_MI2Create(One<Host> pick_ host, const String& exefile, const String& cmdline, bool console);
#ifdef PLATFORM_WIN32
One<Debugger> CdbCreate(One<Host> pick_ host, const String& exefile, const String& cmdline);
One<Debugger> PdbCreate(One<Host> pick_ host, const String& exefile, const String& cmdline);
#endif
